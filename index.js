...
async function fetchLibraryInfo() {
    const URL_LIBRARY = `https://docs.google.com/spreadsheets/d/${SHEET_ID}/gviz/tq?tqx=out:json&sheet=Sheet3`;
    try {
...
function showDetails() {
    ...
    headers.forEach((header, index) => {
        ...
        switch (index) {
            ...
            case 1: value.textContent = row.presentDays; break;
            ...
            case 5: value.textContent = absentDays; break;
